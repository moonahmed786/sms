            ...
            <div class="box-inner">
                ...
                <div class="box-content">
                    ...
                    @endif
                        ...
                        <form role="form" action="<?php echo url();?>/institute" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="text"  class="form-control" required name="web" placeholder="www.ProtonLab.com" value="{{$institute->web}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-info-sign blue"></i></span>
                                                <input type="email" class="form-control" required name="email" placeholder="admin@ProtonLab.com" value="{{$institute->email}}">
